...
func New(db *gorm.DB, p *poller.Poller, hub *ws.Hub, rad *radius.Service, sched *cron.Scheduler, hybridCache *cache.HybridCache) *fiber.App {
	...
	api.Post("/settings/genieacs/parameter-display", settingsGnH.CreateParameterDisplay)
	api.Put("/settings/genieacs/parameter-display", settingsGnH.BulkUpdateParameterDisplay)
	api.Put("/settings/genieacs/parameter-display/:id", settingsGnH.UpdateParameterDisplay)
	api.Delete("/settings/genieacs/parameter-display/:id", settingsGnH.DeleteParameterDisplay)
	...
	genieacs.Post("/faults/bulk-delete", genieacsH.DeleteFaultsBulk)
	// Config
