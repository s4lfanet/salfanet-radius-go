...
export default function TopUpRequestsPage() {
  ...
  return (
    <div className="bg-background relative">
      ...
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-xl sm:text-2xl font-bold text-foreground dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-brand-400 dark:via-white dark:to-accent-foreground dark:drop-shadow-[0_0_30px_rgba(70, 95, 255,0.5)] mb-2">{t('topup.requestsTitle')}</h1>
