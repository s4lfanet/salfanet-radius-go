    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4">
          <Loader2 className="w-12 h-12 animate-spin text-brand-500 dark:text-brand-400 dark:drop-shadow-[0_0_20px_rgba(70, 95, 255,0.6)]" />
          <p className="text-brand-400 font-medium animate-pulse">{t('network.loadingVpnClients')}</p>
        </div>
      </div>
    );
  }
    ...
    <>
      <main className="bg-background relative">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none dark:block hidden">
          <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-brand-600/15 rounded-full blur-[120px] animate-pulse"></div>
          ...
          <div className="absolute bottom-0 left-1/2 w-[600px] h-[400px] bg-accent/10 rounded-full blur-[150px] animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10 p-6 lg:p-8">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  <div className="p-2.5 bg-gradient-to-br from-brand-400 to-brand-600 rounded-xl shadow-[0_0_20px_rgba(70, 95, 255,0.4)] flex items-center justify-center">
                    <Users className="w-6 h-6 text-white" />
                  </div>
                  <h1 className="text-3xl lg:text-4xl font-bold text-foreground dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-brand-400 dark:via-white dark:to-accent-foreground">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-brand-400 to-[#00d4e6] text-black font-bold rounded-xl hover:shadow-[0_0_30px_rgba(70, 95, 255,0.5)] transition-all duration-300 transform hover:scale-105"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-xl border border-brand-600/30 p-5 hover:border-brand-600/50 transition-all group">
              <div className="flex items-center justify-between">
                ...
                <div className="p-3 bg-brand-600/20 rounded-xl group-hover:bg-brand-600/30 transition-colors flex items-center justify-center">
                  <Users className="w-6 h-6 text-brand-600" />
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-xl border border-brand-500/30 p-5 hover:border-brand-500/50 transition-all group">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-muted-foreground text-sm mb-1">{t('network.radiusServer')}</p>
                  <p className="text-3xl font-bold text-brand-400">{radiusServers}</p>
                </div>
            ...
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-xl border border-green-500/30 p-5 hover:border-green-500/50 transition-all group">
              <div className="flex items-center justify-between">
                <div>
          ...
          <div className="mb-8">
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl border border-brand-500/20 rounded-xl overflow-hidden">
              <button
              ...
              {showTutorial && (
                <div className="px-6 pb-6 border-t border-brand-500/10">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-5">
                    {[
                      { step: 1, icon: '???', color: 'border-brand-600/40 bg-brand-600/5', title: 'VPN Server Dulu', desc: 'Pastikan VPN Server sudah dikonfigurasi di menu VPN Server (MikroTik CHR atau WireGuard VPS).', link: '/admin/network/vpn-server', linkLabel: '? Menu VPN Server' },
                      ...
                      <div key={item.step} className={`rounded-xl border ${item.color} p-4`}>
                        ...
                        {item.link && (
                          <a href={item.link} className="inline-block mt-2 text-xs font-medium text-brand-400 hover:underline">{item.linkLabel}</a>
                        )}
                      </div>
                    ))}
                  </div>
          ...
          <div className="mb-8">
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl border border-brand-500/30 rounded-xl overflow-hidden">
              <button
                onClick={() => {
              ...
              {showVpsSettings && (
                <div className="border-t border-brand-500/20 px-6 py-5 space-y-6">
                  ...
                  {wgServerInfoLoading ? (
                    ...
                    <div className="p-4 rounded-xl border border-slate-700/40 bg-slate-900/40 text-center">
                      ...
                      <a href="/admin/network/vpn-server" className="text-xs text-brand-400 hover:underline mt-1 inline-block">? Install dari menu VPN Server</a>
                    </div>
                  )}
                  ...
                  {l2tpServerInfoLoading ? (
                    ...
                    <div className="p-4 rounded-xl border border-brand-600/30 bg-brand-600/5">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        {!l2tpPoolEdit && (
                          <button
                            ...
                            className="text-xs text-brand-600 hover:text-[#d060ff] border border-brand-600/40 px-2 py-1 rounded-lg"
                          >
                            Edit
                          </button>
                        )}
                      ...
                      {!l2tpPoolEdit ? (
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2 pt-1">
                            <button onClick={handleL2tpSavePoolConfig} disabled={l2tpPoolSaving} className="flex-1 py-2 bg-brand-600 text-white text-sm font-bold rounded-lg hover:bg-[#d060ff] disabled:opacity-50 transition-colors">{l2tpPoolSaving ? 'Menyimpan...' : 'Simpan'}</button>
          ...
          {/* Clients List */}
          {clients.length === 0 ? (
            <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl rounded-xl border-2 border-dashed border-brand-600/40 p-16 text-center">
              <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-brand-600/20 to-brand-400/20 rounded-xl flex items-center justify-center">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-brand-400 to-[#00d4e6] text-black font-bold rounded-xl hover:shadow-[0_0_30px_rgba(70, 95, 255,0.5)] transition-all duration-300 transform hover:scale-105"
              >
                <Plus className="w-5 h-5" />
            ...
            <div className="grid gap-4">
              {clients.map((client) => (
                <div
                  key={client.id}
                  className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl border border-brand-600/30 rounded-xl overflow-hidden hover:border-brand-500/50 hover:shadow-[0_0_30px_rgba(70, 95, 255,0.15)] transition-all duration-300 group"
                >
                  <div className="p-6">
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="p-2 bg-gradient-to-br from-brand-400/30 to-brand-600/30 rounded-lg flex items-center justify-center">
                            <Shield className="w-5 h-5 text-brand-400" />
                          </div>
                          <h3 className="font-bold text-lg text-foreground group-hover:text-brand-400 transition-colors">{client.name}</h3>
                          {client.isRadiusServer && (
                            <span className="px-3 py-1 text-xs font-bold rounded-lg bg-brand-500/20 text-brand-400 border border-brand-500/50 shadow-[0_0_10px_rgba(70, 95, 255,0.3)]">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                          <div>
                            <p className="text-brand-400 text-xs uppercase tracking-wider mb-1">{t('network.vpnServer')}</p>
                            <p className="font-medium text-foreground text-sm">
                              {resolveServer(client.vpnServerId)?.name || 'N/A'}
                            </p>
                          </div>
                          <div>
                            <p className="text-brand-400 text-xs uppercase tracking-wider mb-1">{t('network.vpnIp')}</p>
                            {editingIpClientId === client.id ? (
                              <div className="flex items-center gap-1.5">
                                <input
                                  ...
                                  className="w-32 px-2 py-1 text-xs font-mono bg-background border border-brand-500/50 rounded-lg text-foreground focus:border-brand-500 focus:ring-1 focus:ring-[brand-400]/30 outline-none"
                                  autoFocus
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  ...
                                  className="p-1 bg-brand-500/10 border border-brand-500/30 text-brand-400 rounded-lg hover:bg-brand-500/20 transition-all opacity-60 hover:opacity-100"
                                  title="Edit IP"
                                >
                          ...
                          <div>
                            <p className="text-brand-400 text-xs uppercase tracking-wider mb-1">{t('network.username')}</p>
                            <p className="font-mono text-foreground text-sm">{client.username}</p>
                          </div>
                          {client.winboxPort && (
                            <div>
                              <p className="text-brand-400 text-xs uppercase tracking-wider mb-1">{t('network.winboxRemote')}</p>
                              <p className="font-mono text-brand-400 text-sm drop-shadow-[0_0_6px_rgba(70, 95, 255,0.6)]">
                        ...
                        {/* RADIUS Toggle */}
                        <div className="mt-4 pt-4 border-t border-brand-600/20">
                          <label className="flex items-center gap-3 cursor-pointer w-fit">
                            <input
                              type="checkbox"
                              checked={client.isRadiusServer || false}
                              onChange={(e) => handleToggleRadiusServer(client.id, e.target.checked)}
              className="w-5 h-5 rounded border-brand-600/50 bg-background dark:bg-slate-900 text-brand-400 focus:ring-[brand-400]/50 focus:ring-offset-0"
                            />
                        ...
                        {client.isRadiusServer && (
                          <div className="mt-4 pt-4 border-t border-brand-500/20">
                            <button
                              ...
                              className="flex items-center gap-2 text-sm font-medium text-brand-400 hover:text-white transition-colors w-full text-left"
                            >
                              <div className="p-1.5 bg-brand-500/20 rounded-lg flex items-center justify-center">
                            ...
                            {expandedRoutingPanels.has(client.id) && (
                              <div className="mt-3 rounded-xl overflow-hidden border border-brand-500/20">
                                {/* Panel header */}
                                <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-brand-400/10 to-brand-600/10 border-b border-brand-500/20">
                                  <div>
                                    <p className="text-xs font-bold text-brand-400 uppercase tracking-wider">{t('network.vpsRoutingSetup')}</p>
                                  ...
                                  <button
                                    ...
                                    className="flex items-center gap-1.5 px-3 py-1.5 bg-brand-500/20 border border-brand-500/30 text-brand-400 rounded-lg hover:bg-brand-500/30 transition-all text-xs font-medium flex-shrink-0"
                                  >
                                  ...
                                  <button
                                    ...
                                    className="flex items-center gap-1.5 px-3 py-1.5 bg-brand-600/20 border border-brand-600/30 text-brand-600 rounded-lg hover:bg-brand-600/30 transition-all text-xs font-medium flex-shrink-0"
                                  >
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0 lg:pt-1">
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2.5 bg-brand-500/20 border border-brand-500/40 text-brand-400 rounded-xl hover:bg-brand-500/30 transition-all"
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-2.5 sm:p-4">
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-brand-600/50 rounded-xl max-w-lg w-full p-6 shadow-[0_0_50px_rgba(122, 90, 248,0.3)]">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2 bg-gradient-to-br from-brand-400 to-brand-600 rounded-lg flex items-center justify-center">
              ...
              <form onSubmit={handleCreate} className="space-y-5">
                <div>
                  ...
                  >
                    ...
                    {formData.vpnType === 'wireguard' && wgServerInfo?.installed && (
                      <option value="__vps_wg__" className="bg-slate-800">
                        ??? VPS WireGuard Server ({wgServerInfo.publicIp || 'VPS'} :{wgServerInfo.listenPort || 51820})
                      </option>
                    )}
                    {/* VPS L2TP option */}
                    ...
                    {formData.vpnType === 'l2tp' && l2tpServerInfo?.installed && (
                      <option value="__vps_l2tp__" className="bg-slate-800">
                        ??? VPS L2TP/IPsec Server ({l2tpServerInfo.publicIp || 'VPS'})
                      </option>
                    )}
                    {/* CHR servers */}
                    {vpnServers
                  ...
                  {formData.vpnType === 'wireguard' && !wgServerInfoLoading && wgServerInfo && !wgServerInfo.installed && vpnServers.filter(s => s.wgEnabled).length === 0 && (
                    <p className="text-xs text-amber-400 mt-1.5">
                      ...
                      <a href="/admin/network/vpn-server" className="text-brand-400 underline ml-1">Setup di menu VPN Server</a>.
                    </p>
                  )}
                  ...
                  {formData.vpnType && (formData.vpnType === 'sstp' || formData.vpnType === 'pptp') && vpnServers.filter(server => {
                    ...
                    <p className="text-xs text-amber-400 mt-1.5 flex items-center gap-1">
                      ...
                      <span> Setup di</span><a href="/admin/network/vpn-server" className="text-brand-400 underline ml-1">menu VPN Server</a>.
                    </p>
                  )}
                </div>
                ...
                <div>
                    ...
                    {(['wireguard', 'l2tp', 'pptp', 'sstp'] as const).map((type) => (
                      <button
                        ...
                        className={`px-3 py-2.5 rounded-xl text-sm font-bold transition-all ${formData.vpnType === type
                          ? 'bg-gradient-to-r from-brand-400 to-[#00d4e6] text-black shadow-[0_0_15px_rgba(70, 95, 255,0.4)]'
                          : 'bg-muted/60 dark:bg-slate-800/60 border border-brand-600/30 text-foreground hover:bg-brand-600/20'
                        }`}
                      >
                  ...
                  {formData.vpnType === 'wireguard' && (
                    <p className="text-xs text-brand-400/80 mt-2 flex items-center gap-1"><Wifi className="w-3 h-3" /> WireGuard memerlukan RouterOS 7+ di NAS. Sistem akan menambah peer ke CHR secara otomatis.</p>
                  )}
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-input border border-border rounded-xl text-foreground placeholder-gray-500 focus:border-brand-500 focus:ring-2 focus:ring-[brand-400]/30 transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-input border border-border rounded-xl text-foreground placeholder-gray-500 focus:border-brand-500 focus:ring-2 focus:ring-[brand-400]/30 transition-all resize-none"
                ...
                {(formData.vpnType === 'wireguard' || (formData.vpnType === 'l2tp' && formData.vpnServerId === '__vps_l2tp__')) && (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-input border border-border rounded-xl text-foreground placeholder-gray-500 font-mono focus:border-brand-500 focus:ring-2 focus:ring-[brand-400]/30 transition-all"
                      placeholder="cth: 192.168.75.0/24,136.1.1.100/32"
                    />
                    <p className="text-xs text-muted-foreground mt-1">
                      {formData.vpnType === 'wireguard'
                        ? <>Pisahkan dengan koma. IP/subnet ini akan ditambahkan ke <span className="text-brand-400 font-mono">AllowedIPs</span> peer WireGuard di VPS sehingga VPS bisa menjangkau jaringan lokal di balik NAS.</>
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    type="submit"
                    disabled={creating}
                    className="flex-1 px-4 py-3 bg-gradient-to-r from-brand-400 to-[#00d4e6] text-black font-bold rounded-xl hover:shadow-[0_0_20px_rgba(70, 95, 255,0.4)] transition-all disabled:opacity-50"
                  >
        ...
        {showCredentials && credentials && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-2.5 sm:p-4">
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-brand-600/50 rounded-xl max-w-4xl w-full p-6 shadow-[0_0_50px_rgba(122, 90, 248,0.3)] max-h-[90vh] overflow-y-auto">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2 bg-gradient-to-br from-brand-400 to-brand-600 rounded-lg flex items-center justify-center">
              ...
              <div className="space-y-6">
                {/* Credentials Grid */}
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 p-5 bg-gradient-to-br from-brand-600/10 to-brand-400/10 border border-brand-600/30 rounded-xl">
                  <div>
                    <p className="text-brand-400 text-xs uppercase tracking-wider mb-1">{t('network.vpnServer')}</p>
                  ...
                  <div>
                    <p className="text-brand-400 text-xs uppercase tracking-wider mb-1">{t('network.password')}</p>
                    <p className="font-mono text-sm text-foreground">{credentials.password}</p>
                  </div>
                  {credentials.winboxRemote && (
                    <div>
                      <p className="text-brand-400 text-xs uppercase tracking-wider mb-1">{t('network.winboxRemote')}</p>
                      <p className="font-mono text-sm text-brand-400 drop-shadow-[0_0_6px_rgba(70, 95, 255,0.6)]">{credentials.winboxRemote}</p>
                    </div>
                  )}
                  {credentials.apiUsername && (
                    <div>
                      <p className="text-brand-400 text-xs uppercase tracking-wider mb-1">{t('network.apiUsername')}</p>
                      <p className="font-mono text-sm text-green-400">{credentials.apiUsername}</p>
                    </div>
                  )}
                  {credentials.apiPassword && (
                    <div>
                      <p className="text-brand-400 text-xs uppercase tracking-wider mb-1">{t('network.apiPassword')}</p>
                      <p className="font-mono text-sm text-green-400">{credentials.apiPassword}</p>
                    </div>
                  )}
                  {credentials.radiusServerIp && (
                    <div className="col-span-2 mt-1 p-3 bg-brand-600/10 border border-brand-600/30 rounded-lg">
                      <p className="text-brand-600 text-xs uppercase tracking-wider mb-2 font-bold">RADIUS Configuration</p>
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <p className="text-brand-600 text-xs uppercase tracking-wider mb-1">RADIUS Server IP</p>
                          <p className="font-mono text-sm text-amber-300">{credentials.radiusServerIp}</p>
                        </div>
                        <div>
                          <p className="text-brand-600 text-xs uppercase tracking-wider mb-1">NAS Secret</p>
                ...
                {/* VPN Type Selector */}
                <div className="p-5 bg-brand-500/10 border border-brand-500/30 rounded-xl">
                  <p className="text-sm font-medium text-brand-400 mb-3 uppercase tracking-wider">
                    ...
                    {(['wireguard', 'l2tp', 'pptp', 'sstp'] as const).map((type) => (
                      <button
                        ...
                        className={`flex-1 min-w-[80px] px-4 py-2.5 rounded-xl text-sm font-bold transition-all ${selectedVpnType === type
                          ? 'bg-gradient-to-r from-brand-400 to-[#00d4e6] text-black shadow-[0_0_20px_rgba(70, 95, 255,0.4)]'
                          : 'bg-muted/60 dark:bg-slate-800/60 border border-brand-600/30 text-foreground hover:bg-brand-600/20'
                          }`}
                      >
                        {type === 'l2tp' ? 'L2TP/IPSec' : type === 'wireguard' ? 'WireGuard' : type.toUpperCase()}
                  ...
                  {selectedVpnType === 'wireguard' && (
                    <div className="mt-3 p-3 bg-brand-600/10 border border-brand-600/30 rounded-xl">
                      <div className="flex items-start gap-2">
                        <Key className="w-4 h-4 text-brand-600 mt-0.5 flex-shrink-0" />
                        <div>
                          <p className="text-xs font-bold text-brand-600 mb-1">WireGuard Keys</p>
                          {credentials.clientPrivateKey ? (
                            <div className="space-y-1">
                              <div className="flex items-center gap-2">
                                ...
                                <button onClick={() => copyToClipboard(credentials.clientPrivateKey!)} className="text-xs text-brand-400 hover:underline shrink-0"><Copy className="w-3 h-3" /></button>
                              </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-brand-600 to-accent-foreground text-white font-bold rounded-lg hover:shadow-[0_0_20px_rgba(122, 90, 248,0.4)] transition-all text-sm"
                    >
                      <Copy className="w-4 h-4" />
                      {t('network.copyScript')}
                    </button>
                  </div>
                  <pre className="p-5 bg-gray-100 dark:bg-slate-950 text-green-700 dark:text-green-400 border border-brand-600/30 rounded-xl text-xs overflow-auto max-h-80 whitespace-pre font-mono">
                ...
                <div className="p-5 bg-amber-500/10 border border-amber-500/30 rounded-xl">
                  ...
                  <ul className="text-xs sm:text-sm text-foreground space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-amber-400 mt-0.5 flex-shrink-0" />
              <span><strong className="text-amber-300 dark:text-amber-300 text-amber-600">{t('network.remoteAccess')}:</strong> {t('network.useWinboxVia')} <code className="px-1.5 py-0.5 bg-muted dark:bg-slate-800 border border-brand-500/30 rounded text-brand-400">{credentials.winboxRemote}</code></span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-amber-400 mt-0.5 flex-shrink-0" />
              ...
              <button
                ...
                className="w-full mt-6 px-4 py-4 bg-gradient-to-r from-brand-600 to-accent-foreground hover:from-brand-600/90 hover:to-accent-foreground/90 rounded-xl transition-all font-bold text-white shadow-[0_0_20px_rgba(122, 90, 248,0.4)]"
              >
                {t('common.close')}
              </button>
            </div>
        ...
        {showApplyRoutingModal && applyRoutingClient && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-2.5 sm:p-4">
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-brand-500/50 rounded-xl max-w-xl w-full p-6 shadow-[0_0_50px_rgba(70, 95, 255,0.3)] max-h-[90vh] overflow-y-auto">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Terapkan routing script ke VPS: <span className="text-brand-400 font-medium">{applyRoutingClient.name}</span>
              </p>

              <div className="p-4 rounded-xl border border-brand-500/30 bg-muted/50 dark:bg-slate-900/60 mb-4">
                <p className="text-xs font-bold text-brand-400 mb-3">?? SSH Credentials VPS RADIUS</p>
                <input
              ...
              {applyRoutingOutput && (
                <div className="mb-4 p-3 bg-gray-100 dark:bg-slate-950 rounded-xl border border-brand-500/20 max-h-52 overflow-y-auto">
                  <p className="text-brand-400 text-xs uppercase mb-1 font-bold">Output:</p>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2.5 text-sm font-bold bg-gradient-to-r from-brand-400 to-[#00d4e6] text-black rounded-xl hover:shadow-[0_0_20px_rgba(70, 95, 255,0.4)] transition-all disabled:opacity-50"
                >
