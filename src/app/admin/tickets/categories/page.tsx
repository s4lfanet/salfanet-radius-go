      ...
      <div className="relative z-10 space-y-6">
        ...
        {loading ? (
          <div className="flex items-center justify-center min-h-[60vh]">
            ...
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-brand-500 dark:border-brand-500 dark:drop-shadow-[0_0_20px_rgba(70, 95, 255,0.6)] relative z-10"></div>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {categories.map((category) => (
              <div
                key={category.id}
                className="bg-card dark:bg-[#1a1525]/80 backdrop-blur-sm border border-border dark:border-brand-600/30 rounded-lg p-2.5 sm:p-4 hover:border-primary/30 dark:hover:border-brand-500/50 transition-all dark:hover:shadow-[0_0_20px_rgba(70, 95, 255,0.3)]"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
          <div className="bg-card dark:bg-[#1a1525]/80 backdrop-blur-sm border border-border dark:border-brand-600/30 rounded-lg p-2.5 sm:p-4 hover:border-primary/30 dark:hover:border-brand-500/50 transition-all">
          ...
          <div className="bg-card dark:bg-[#1a1525]/80 backdrop-blur-sm border border-border dark:border-brand-600/30 rounded-lg p-2.5 sm:p-4 hover:border-red-400/50 transition-all">
          ...
          <div className="bg-card dark:bg-[#1a1525]/80 backdrop-blur-sm border border-border dark:border-brand-600/30 rounded-lg p-2.5 sm:p-4 hover:border-green-500/50 transition-all">
          ...
          <div className="bg-card dark:bg-[#1a1525]/80 backdrop-blur-sm border border-border dark:border-brand-600/30 rounded-lg p-2.5 sm:p-4 hover:border-cyan-500/50 transition-all">
            <p className="text-xs text-muted-foreground mb-1">{t('ticket.categoriesPage.billingSupport')}</p>
            <p className="text-lg sm:text-2xl font-bold text-brand-500 dark:text-cyan-400 dark:drop-shadow-[0_0_10px_rgba(70, 95, 255,0.5)]">{stats.billing}</p>
          </div>
        </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-4 gap-2 mt-2">
                  {colorOptions.map((color) => (
                    <button key={color.value} type="button" onClick={() => setFormData({ ...formData, color: color.value })} className={`w-full h-10 rounded-lg border-2 transition-all ${formData.color === color.value ? 'border-white shadow-[0_0_15px_rgba(255,255,255,0.5)] scale-110' : 'border-brand-600/30 hover:border-brand-500/50'}`} style={{ backgroundColor: color.value }}>
