      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="min-w-0">
            <h1 className="text-xl sm:text-2xl font-bold text-foreground dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-brand-400 dark:via-white dark:to-accent-foreground dark:drop-shadow-[0_0_30px_rgba(70, 95, 255,0.5)]">{t('invoices.title')}</h1>
          ...
          <div className="flex gap-1.5 flex-wrap">
            ...
            <Link href="/admin/invoices/import">
              <button className="inline-flex items-center px-2 py-1.5 text-xs border border-brand-600/60 text-foreground rounded hover:bg-brand-600/10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4">
          <div className="bg-card/80 backdrop-blur-xl rounded-xl border-2 border-brand-600/30 p-3 sm:p-4 shadow-[0_0_20px_rgba(122, 90, 248,0.2)] hover:border-brand-600/50 transition-all">
            <div className="flex items-center justify-between gap-2">
              <div className="min-w-0">
                <p className="text-[10px] sm:text-xs text-brand-400 uppercase tracking-wide truncate">{t('common.total')}</p>
                <p className="text-lg sm:text-2xl font-bold text-foreground mt-1">{stats.total}</p>
              </div>
              <div className="p-1.5 sm:p-2 rounded-lg shadow-lg bg-brand-600/20 flex-shrink-0 flex items-center justify-center">
          ...
          <div className="bg-card/80 backdrop-blur-xl rounded-xl border-2 border-brand-600/30 p-3 sm:p-4 shadow-[0_0_20px_rgba(122, 90, 248,0.2)] hover:border-brand-600/50 transition-all">
            <div className="flex items-center justify-between gap-2">
              <div className="min-w-0">
                <p className="text-[10px] sm:text-xs text-brand-400 uppercase tracking-wide truncate">{t('invoices.pending')}</p>
          ...
          <div className="bg-card/80 backdrop-blur-xl rounded-xl border-2 border-brand-600/30 p-3 sm:p-4 shadow-[0_0_20px_rgba(122, 90, 248,0.2)] hover:border-brand-600/50 transition-all">
            <div className="flex items-center justify-between gap-2">
              <div className="min-w-0">
                <p className="text-[10px] sm:text-xs text-brand-400 uppercase tracking-wide truncate">{t('invoices.paid')}</p>
          ...
          <div className="bg-card/80 backdrop-blur-xl rounded-xl border-2 border-brand-600/30 p-3 sm:p-4 shadow-[0_0_20px_rgba(122, 90, 248,0.2)] hover:border-brand-600/50 transition-all">
            <div className="flex items-center justify-between gap-2">
              <div className="min-w-0">
                <p className="text-[10px] sm:text-xs text-brand-400 uppercase tracking-wide truncate">{t('invoices.overdue')}</p>
                  ...
                  <div className="space-y-1 text-[11px] ml-6">
                    ...
                    {(invoice.user?.customerId) && (
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono text-brand-400">{invoice.user.customerId}</span>
                      </div>
                    )}
                    <div className="flex justify-between">
