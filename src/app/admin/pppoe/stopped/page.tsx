    ...
    <div className="bg-background relative">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-foreground dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-brand-400 dark:via-white dark:to-accent-foreground dark:drop-shadow-[0_0_30px_rgba(70, 95, 255,0.5)]">{t('pppoe.stoppedSubscriptions')}</h1>
      ...
      <div className="flex flex-wrap gap-2">
        <button 
          ...
          className="px-3 py-1.5 text-xs bg-accent hover:bg-accent/90 text-black font-bold rounded-lg flex items-center gap-1.5 shadow-[0_0_15px_rgba(70, 95, 255,0.3)] hover:shadow-[0_0_20px_rgba(70, 95, 255,0.5)] transition-all border border-accent/50"
        >
