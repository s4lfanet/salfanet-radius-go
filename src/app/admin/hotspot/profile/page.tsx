              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-[success]/10 p-2 rounded-lg border border-[success]/30">
                    <div className="text-[10px] text-muted-foreground">{t('hotspot.sellingPrice')}</div>
                    <div className="text-base font-bold text-[success] drop-shadow-[0_0_10px_rgba(18, 183, 106,0.5)]">{formatCurrency(sellingPrice)}</div>
                  </div>
                  <div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    <div>
                      ...
                      <ModalSelect value={formData.validityUnit} onChange={(e) => setFormData({ ...formData, validityUnit: e.target.value })}>
                        <option value="MINUTES" className="dark:bg-input">{t('hotspot.minutes')}</option>
                        <option value="HOURS" className="dark:bg-input">{t('hotspot.hours')}</option>
                        <option value="DAYS" className="dark:bg-input">{t('hotspot.days')}</option>
                        <option value="MONTHS" className="dark:bg-input">{t('hotspot.months')}</option>
                      </ModalSelect>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="mt-1.5 px-2 py-1.5 bg-muted/30 rounded text-[10px] font-mono text-brand-400">
                  ...
                  <div className="border border-brand-500/30 rounded-lg p-3 bg-brand-500/5">
                    <div className="text-[10px] font-medium text-brand-400 mb-2">?? Pembatasan Penggunaan</div>
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          ...
                          <ModalSelect value={formData.usageQuotaUnit} onChange={(e) => setFormData({ ...formData, usageQuotaUnit: e.target.value })} className="w-20">
                            <option value="MB" className="dark:bg-input">MB</option>
                            <option value="GB" className="dark:bg-input">GB</option>
                          </ModalSelect>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          ...
                          <ModalSelect value={formData.usageDurationUnit} onChange={(e) => setFormData({ ...formData, usageDurationUnit: e.target.value })} className="w-20">
                            <option value="MINUTES" className="dark:bg-input">Menit</option>
                            <option value="HOURS" className="dark:bg-input">Jam</option>
                  ...
                  <div className="border border-brand-600/30 rounded-lg p-3 space-y-2 bg-brand-600/5">
                    <div className="text-[10px] font-medium text-brand-600 mb-2">?? Access Control</div>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="checkbox" checked={formData.agentAccess} onChange={(e) => setFormData({ ...formData, agentAccess: e.target.checked })} className="rounded border-brand-600/50 bg-background dark:bg-input accent-brand-500 dark:accent-[brand-400]" />
                      <span className="text-xs text-foreground">{t('hotspot.agentAccess')}</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="checkbox" checked={formData.eVoucherAccess} onChange={(e) => setFormData({ ...formData, eVoucherAccess: e.target.checked })} className="rounded border-brand-600/50 bg-background dark:bg-input accent-brand-500 dark:accent-[brand-400]" />
