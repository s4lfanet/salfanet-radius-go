...
cmds = [
    "show traffic-profile name DOWN-PPPOE",
    "show traffic-profile name UP-PPPOE",
    "show traffic-profile",
    "show gpon dba-profile name UP-PPPOE",
    "show pon-onu-mng gpon-onu_1/1/1:1",
    "show running-config pon-onu-mng interface gpon-onu_1/1/1:1",
