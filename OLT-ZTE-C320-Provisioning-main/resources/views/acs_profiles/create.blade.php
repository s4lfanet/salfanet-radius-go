...
<div class="mb-6">
    <div class="flex items-center space-x-3">
        ...
        <h1 class="text-2xl font-bold" style="color: var(--text-primary);">Add New ACS Profile</h1>
    </div>
</div>
    ...
    <form action="{{ route('acs-profiles.store') }}" method="POST" class="p-6">
        ...
        <div class="space-y-5">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="e.g. Primary ACS" required class="block w-full rounded-xl sm:text-sm px-4 py-2.5 transition-all duration-200 focus:outline-none focus:ring-2" style="background: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary); --tw-ring-color: var(--accent);">
            ...
            <div>
                ...
                <input type="url" name="url" id="url" placeholder="http://domain.com:7547" required class="block w-full rounded-xl sm:text-sm px-4 py-2.5 transition-all duration-200 focus:outline-none focus:ring-2" style="background: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary); --tw-ring-color: var(--accent);">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text" name="username" id="username" placeholder="acsuser" class="block w-full rounded-xl sm:text-sm px-4 py-2.5 transition-all duration-200 focus:outline-none focus:ring-2" style="background: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary); --tw-ring-color: var(--accent);">
                ...
                <div>
                    ...
                    <input type="text" name="password" id="password" placeholder="acspassword" class="block w-full rounded-xl sm:text-sm px-4 py-2.5 transition-all duration-200 focus:outline-none focus:ring-2" style="background: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary); --tw-ring-color: var(--accent);">
        ...
        <div class="mt-8 flex justify-end space-x-3">
            ...
            <button type="submit" class="py-2.5 px-5 rounded-xl text-sm font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-cyan-500/25 hover:scale-105" style="background: linear-gradient(135deg, #06b6d4, #0891b2);">Save Profile</button>
        </div>
    </form>
</div>
@endsection
