...
<div class="mb-6">
    <div class="flex items-center space-x-3">
        ...
        <h1 class="text-2xl font-bold" style="color: var(--text-primary);">Add New OLT</h1>
    </div>
</div>
    ...
    <form action="{{ route('olts.store') }}" method="POST" class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="col-span-2">
                ...
                <input type="text" name="name" id="name" class="mt-1 block w-full rounded-xl sm:text-sm px-4 py-2.5 transition-all duration-200 focus:outline-none focus:ring-2" style="background: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary); --tw-ring-color: var(--accent);" value="{{ old('name') }}" placeholder="e.g. OLT-Main-Building">
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="text" name="ip" id="ip" class="mt-1 block w-full rounded-xl sm:text-sm px-4 py-2.5 transition-all duration-200 focus:outline-none focus:ring-2" style="background: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary); --tw-ring-color: var(--accent);" required placeholder="e.g. 192.168.1.1">
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="telnet_username" id="telnet_username" class="mt-1 block w-full rounded-xl sm:text-sm px-4 py-2.5 transition-all duration-200 focus:outline-none focus:ring-2" style="background: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary); --tw-ring-color: var(--accent);">
                    ...
                    <div>
                        ...
                        <input type="password" name="telnet_password" id="telnet_password" class="mt-1 block w-full rounded-xl sm:text-sm px-4 py-2.5 transition-all duration-200 focus:outline-none focus:ring-2" style="background: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary); --tw-ring-color: var(--accent);">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select name="snmp_version" id="snmp_version" class="mt-1 block w-full rounded-xl sm:text-sm px-4 py-2.5 transition-all duration-200 focus:outline-none focus:ring-2" style="background: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary); --tw-ring-color: var(--accent);" onchange="toggleSnmpLabels(this.value)">
                            <option value="v2c" {{ old('snmp_version', 'v2c') == 'v2c' ? 'selected' : '' }}>SNMPv2c (Community String)</option>
                            <option value="v3" {{ old('snmp_version') == 'v3' ? 'selected' : '' }}>SNMPv3 (Username/Password)</option>
                        </select>
                    ...
                    <div id="snmp_password_row">
                        ...
                        <input type="password" name="snmp_password" id="snmp_password" class="mt-1 block w-full rounded-xl sm:text-sm px-4 py-2.5 transition-all duration-200 focus:outline-none focus:ring-2" style="background: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary); --tw-ring-color: var(--accent);">
